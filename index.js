...
listview.onclick = () => {
    ...
    productslist.classList.remove("pro-grid-container");
    productslist.classList.add("pro-list-container");
};

gridview.onclick = () => {
    console.log("List Clicked");
    productslist.classList.remove("pro-list-container");
    productslist.classList.add("pro-grid-container");
};
